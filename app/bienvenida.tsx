...
export default function BienvenidaScreen() {
  function entrarComoInvitado() {
    // Equivalente a: sharedPref.edit().putBoolean("is_guest", true).apply()
    // (más adelante lo guardaremos de verdad con AsyncStorage; por ahora solo navega)
    router.replace("/(tabs)");
  }

  function iniciarSesion() {
    // Placeholder, igual que en tu código Kotlin (Toast "en desarrollo")
    Alert.alert(
      "En desarrollo",
